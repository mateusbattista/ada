...
const TermoAdesaoList : React.FC = () => {
...
// captura o id do botão de editar clicado
    ...
    useEffect(() => {
        const handleEnviar = () => {
            if (itemEditar.id !== '') {
                navigate('/ada/termoadesao/createEdit', { state: { itemEditar } });
            }
        };
        handleEnviar();
    }, [itemEditar, navigate]);
                            ...
                            <Card.Header className='mr-auto'>
                                <div className='d-flex'>
                                    <div className='ml-auto'>
                                        <a href='/ada/termoadesao/createEdit' className='br-button mr-3 primary'>
...
export default TermoAdesaoList;

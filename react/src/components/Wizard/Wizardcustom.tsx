...
const Wizard = React.forwardRef<HTMLDivElement, WizardProps>(
    ({
        ...
        return (
            <div ref={refDiv} style={{height: height, maxHeight: '300%'}}>
                <div
                    ref={refWrapper}
                ...
                >
                    ...
                    <div className="wizard-form" style={{height: '300%', minHeight: '100%'}} ref={refWizardForm}>
                        {Children.map(children, (element, index) => (
                            <div key={index} className="wizard-panel" {...currentStep === (index + 1) && {active: 'active'}} >
                                ...
                                <div className="wizard-panel-btn">
                                    ...
                                    {index === Children.count(children) - 1 && <button className="br-button primary wizard-btn" type="submit" >{concludeButtonText}
                                    </button>}

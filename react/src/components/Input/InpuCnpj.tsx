...
const InputCnpj = React.forwardRef<InputRef, InputProps>(
    ({ className, id, children, label, min, placeholder, type = 'text', density = 'normal', icon, button, highlight, inline, value, status, feedbackText, ...props }, ref) => {
            ...
            >
                ...
                <div ref={refInputContent} className="input-content">
                    <div className="input-group">
                        ...
                        <InputMask mask='99.999.999/9999-99' id={fid} ref={refInput} type={type} min={min} placeholder={placeholder} value={value} {...spreadProps} />
                        {button}
...
InputCnpj.displayName = 'InputCpf';

...
const InputCpf = React.forwardRef<InputRef, InputProps>(
            ...
            >
                ...
                <div ref={refInputContent} className="input-content">
                    <div className="input-group">
                        ...
                        <InputMask mask='999.999.999-99' id={fid} ref={refInput} type={type} min={min} placeholder={placeholder} value={value} {...spreadProps} />
                        {button}

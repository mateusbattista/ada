                ...
                <div class="br-card mb-4">
                    <div class="wizard-form">
                                        ...
                                        <div class="col-sm-12 my-6 mx-4">
                                            <div class="br-select">
                                                <div class="br-input">
                                                    ...
                                                    <input disabled id="tipo_unidade" type="text"
                                                        value="{{ $slc_executora->nome_fantasia }}"
                                                        placeholder="{{ $slc_executora->nome_fantasia }}" />
                                        ...
                                        <div class="col-sm-12 mb-6 mx-4">
                                            <div class="br-select">
                                                <div class="br-input">
                                                    ...
                                                    <input disabled id="tipo_unidade" type="text"
                                                        value="{{ $slc_planooperacional->tipo_unidade }}"
                                                        placeholder="{{ $slc_planooperacional->tipo_unidade }}" />
                                                    <button class="br-button" type="button" aria-label="Exibir lista"
                                                        tabindex="-1" data-trigger="data-trigger"><i
                                                            class="fas fa-angle-down" aria-hidden="true"></i>
                                                    </button>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12 mb-6 mx-4">
                                            <div class="br-input">
                                                ...
                                                <input disabled id="tipo_parceria" type="text" name="tipo_parceria"
                                                    value="{{ $slc_planooperacional->tipo_parceria }}"
                                                    placeholder="{{ $slc_planooperacional->tipo_parceria }}" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12 mb-6 mx-4">
                                            <div class="br-input">
                                                ...
                                                <input disabled id="numero_instrumento" type="text"
                                                    name="numero_instrumento"
                                                    value="{{ $slc_planooperacional->n_instrumento_parceria }}"
                                                    placeholder="{{ $slc_planooperacional->n_instrumento_parceria }}" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12 mb-6 mx-4">
                                            <div class="br-input">
                                                ...
                                                <input disabled id="numero_sei" type="text" name="numero_sei"
                                                    value="{{ $slc_planooperacional->n_processo_sei }}"
                                                    placeholder="{{ $slc_planooperacional->n_processo_sei }}" />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-12 mb-6 mx-4">
                                            <div class="br-select">
                                                <div class="br-input">
                                                    ...
                                                    <input disabled id="select-estado" value="{{ $slc_estado }}"
                                                        type="text" name="estado_entidade"
                                                        placeholder="{{ $slc_planooperacional->estado_entidade }}" />
                                                    <button class="br-button" type="button" aria-label="Exibir lista"
                                                        tabindex="-1" data-trigger="data-trigger"><i
                                                            class="fas fa-angle-down" aria-hidden="true"></i>
                                                    </button>
                                                        ...
                                                        <div class="col-sm-12 mb-6">
                                                            <div class="br-input">
                                                                <label for="nome_ministerio">Órgão /
                                                                    Unidade:</label>
                                                                <input disabled id="nome_ministerio" type="text"
                                                        ...
                                                        <div class="col-sm-12 mb-6">
                                                            <div class="br-input">
                                                                <label for="cpf_responsavel_ministerio">Número
                                                                    CPF:</label>
                                                                <input disabled id="cpf_responsavel_ministerio"
                                                                    type="text" name="cpf_responsavel_ministerio"
                                                                    placeholder="" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-sm-12 mb-6">
                                                            <div class="br-input">
                                                                <label for="nome_responsavel_ministerio">Nome do
                                                                    Responsável:</label>
                                                                <input disabled id="nome_responsavel_ministerio"
                                                                    type="text" name="nome_responsavel_ministerio"
                                                                    placeholder="" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-12 mb-6">
                                                            <div class="br-input">
                                                                ...
                                                                <input disabled id="cargo_responsavel_ministerio"
                                                                    type="text" name="cargo_responsavel_ministerio"
                                                                    placeholder="" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-12 mb-6">
                                                            <div class="br-input">
                                                                ...
                                                                <input disabled id="email_responsavel_ministerio"
                                                                    type="text" name="email_responsavel_ministerio"
                                                                    placeholder="" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-sm-12 mb-6">
                                                            <div class="br-input">
                                                                <label for="telefone_responsavel_ministerio">Número
                                                                    do
                                                                    DDD/Telefone:</label>
                                                                <input disabled id="telefone_responsavel_ministerio"
                                                                    type="text" name="telefone_responsavel_ministerio"
                                                                    placeholder="" />
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="br-accordion" id="accordion4-negative" single="single">
                                                ...
                                                <div class="content" id="id17">
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-12 mb-6">
                                                            <div class="br-input">
                                                                ...
                                                                <input disabled id="id_cnpj" type="text"
                                                                    name="cnpj_gestora" placeholder="999.9996./0001-99" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-12 mb-6">
                                                            <div class="br-input">
                                                                <label for="nome_gestora">Nome do Órgão / Unidade
                                                                    Gestora:</label>
                                                                <input disabled id="nome_gestora" type="text"
                                                                    name="nome_gestora" placeholder="" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-12 mb-6">
                                                            <div class="br-input">
                                                                <label for="nome_responsavel_gestora">Nome do
                                                                    Responsável:</label>
                                                                <input disabled id="nome_responsavel_gestora"
                                                                    type="text" name="nome_responsavel_gestora"
                                                                    placeholder="" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-12 mb-6">
                                                            <div class="br-input">
                                                                <label for="cargo_responsavel_gestora">Cargo:</label>
                                                                <input disabled id="cargo_responsavel_gestora"
                                                                    type="text" name="cargo_responsavel_gestora"
                                                                    placeholder="" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-12 mb-6">
                                                            <div class="br-input">
                                                                <label for="cpf_responsavel_gestora">Número
                                                                    CPF:</label>
                                                                <input disabled id="cpf_responsavel_gestora"
                                                                    type="text" name="cpf_responsavel_gestora"
                                                                    placeholder="" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-12 mb-6">
                                                            <div class="br-input">
                                                                <label for="email_responsavel_gestora">E-mail:</label>
                                                                <input disabled id="email_responsavel_gestora"
                                                                    type="text" name="email_responsavel_gestora"
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-12 mb-6">
                                                            <div class="br-input">
                                                                <label for="numero_responsavel_gestora">Número do
                                                                    DDD/Telefone:</label>
                                                                <input disabled id="numero_responsavel_gestora"
                                                                    type="text" name="numero_responsavel_gestora"
                                                                    placeholder="" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-sm-12 mb-6">
                                                            <div class="br-input">
                                                                <label for="nome_gestor_termo">Gestor do Termo de
                                                                    Adesão:</label>
                                                                <input disabled id="nome_gestor_termo" type="text"
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-12 mb-6">
                                                            <div class="br-input">
                                                                ...
                                                                <input disabled id="cargo_gestor_termo" type="text"
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-12 mb-6">
                                                            <div class="br-input">
                                                                ...
                                                                <input disabled id="cpf_gestor_termo" type="text"
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-12 mb-6">
                                                            <div class="br-input">
                                                                ...
                                                                <input disabled id="email_gestor_termo" type="text"
                                                        ...
                                                        <div class="col-sm-12 mb-6">
                                                            <div class="br-input">
                                                                <label for="telefone_gestor_termo">Número do
                                                                    DDD/Telefone:</label>
                                                                <input disabled id="telefone_gestor_termo" type="text"
                                            ...
                                            <div class="col-sm-12 mb-2">
                                                <div class="br-input">
                                                    <label for="numero_familias">Nº Total de Famílias a serem
                                                        Atendidas:</label>
                                                    <input disabled id="numero_familias" type="number" min="1"
                                            ...
                                            <div class="col-sm-12 mb-3">
                                                <div class="br-select" multiple="multiple">
                                                    <div class="br-input">
                                                        ...
                                                        <input disabled id="select-multtiple" type="text"
                                                            name="estado2" placeholder="Selecione o(s) Estado(s)" />
                                                    ...
                                                    <div class="br-list" tabindex="0">
                                                        <div class="br-item highlighted" data-all="data-all"
                                                            ...
                                                            <div class="br-checkbox">
                                                                <input disabled id="cb"
                                                                    value="{{ $slc_estado }}" name="cb"
                                                                    type="checkbox" />
                                                        ...
                                                        <div class="br-item" tabindex="-1">
                                                            <div class="br-checkbox">
                                                                <input disabled id="lb{{ $slc_estado }}"
                                                                    type="checkbox" name="estado3"
                                                                    value="{{ $slc_estado }}" />
                                                                <label
                                                                    for="lb{{ $slc_estado }}">{{ $slc_estado }}</label>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-sm-6 ">
                                                ...
                                                <div class="br-datetimepicker" data-mode="single" data-type="text">
                                                    <div class="br-input has-icon">
                                                        ...
                                                        <input disabled id="simples-input" type="text"
                                                            placeholder="dd/mm/aaaa" data-input="data-input" />
                                            ...
                                            <div class="col-sm-12 mb-3">
                                                <div class="br-select">
                                                    <div class="br-input">
                                                        ...
                                                        <input disabled id="select-municipio" name="municipio"
                                                            type="text" placeholder="Selecione o item" />
                                                        <button class="br-button" type="button"
                                                            aria-label="Exibir lista" tabindex="-1"
                                                    ...
                                                    <div class="br-list" id="municipio-list"
                                                        data-url="{{ url('/fomento/fetch-municipios/') }}"
                                                        tabindex="0">
                                            ...
                                            <div class="col-sm-12 mb-2">
                                                <div class="br-input">
                                                    <label for="numeroFamilias">Nº Total de Famílias a serem
                                                        Atendidas:</label>
                                                    <input disabled id="numeroFamilias" type="number" min="1"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12 mb-2">
                                                <div class="br-input">
                                                    ...
                                                    <input disabled id="gtpe_value" type="text" min="1"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12 mb-2">
                                                <div class="br-input">
                                                    ...
                                                    <input disabled id="pct_value" type="text" min="1"
                                                        name="pct_value" placeholder="" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12 mb-4">
                                                <div class="br-textarea">
                                                    ...
                                                    <textarea disabled id="textarea-id8" name='metodologia_mobilizacao' placeholder="Escreva aqui a sua justificativa"
                                                        maxlength="1000">{{ $slc_metodologia->mobilizacao }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-12 mb-4">
                                                <div class="br-textarea">
                                                    ...
                                                    <textarea disabled id="textarea-id8" name='metodologia_diagnostico' placeholder="Escreva aqui a sua justificativa"
                                                        maxlength="1000">{{ $slc_metodologia->diagnostico }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-12 mb-4">
                                                <div class="br-textarea">
                                                    <label for="textarea-id8 mx-2">3 - Atividade de elaboração do
                                                        ...
                                                        adesão:</label>
                                                    <textarea disabled id="textarea-id8" name='metodologia_estruturacao' placeholder="Escreva aqui a sua justificativa"
                                                        maxlength="1000">{{ $slc_metodologia->estruturacao }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-12 mb-4">
                                                <div class="br-textarea">
                                                    <label for="textarea-id8 mx-2">4 - Atividade de acompanhamento
                                                        ...
                                                        adesão:</label>
                                                    <textarea disabled id="textarea-id8" name='metodologia_acompanhamento' placeholder="Escreva aqui a sua justificativa"
                                                        maxlength="1000">{{ $slc_metodologia->acompanhamento }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-12 mb-4">
                                                <div class="br-textarea">
                                                    <label for="textarea-id8 mx-2">5 - Atividade de capacitação
                                                        técnica
                                                        das famílias:</label>
                                                    <textarea disabled id="textarea-id8" name='metodologia_capacitacao' placeholder="Escreva aqui a sua justificativa"
                                                        maxlength="1000">{{ $slc_metodologia->capacitacao }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-12 mb-4">
                                                <div class="br-textarea">
                                                    <label for="textarea-id8 mx-2">6 - Atividade de avaliação:
                                                        ?</label>
                                                    <textarea disabled id="textarea-id8" name='metodologia_avaliacao' placeholder="Escreva aqui a sua justificativa"
                                                        maxlength="1000">{{ $slc_metodologia->avaliacao }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-12 mb-4">
                                                <div class="br-textarea">
                                                    <label for="textarea-id8 mx-2">6 .1- Complemento da Atividade
                                                        de
                                                        avaliação:</label>
                                                    <textarea disabled id="textarea-id8" name='metodologia_complemento_avaliacao'
                                                        placeholder="Escreva aqui a sua justificativa" maxlength="1000">{{ $slc_metodologia->complemento_avaliacao }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="wizard-panel">
                                            ...
                                            <table id="cronograma">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        @for ($x = 1; $x <= 12; $x++)
                                                            @if (in_array($x, $slc_cronograma_mobilizacao))
                                                                <td>
                                                                    <div class='br-checkbox'>
                                                                        <input disabled
                                                                            id='mobilizacao{{ $x }}'
                                                                            name='mobilizacao[]' value={{ $x }}
                                                                            type='checkbox' checked
                                                                            aria-label='mobilizacao{{ $x }}'' />
                                                                        <label
                                                                            for='mobilizacao{{ $x }}'></label>
                                                                    </div>
                                                                </td>
                                                            @else
                                                                <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        @for ($x = 1; $x <= 12; $x++)
                                                            @if (in_array($x, $slc_cronograma_diagnostico))
                                                                <td>
                                                                    <div class='br-checkbox'>
                                                                        <input disabled
                                                                            id='mobilizacao{{ $x }}'
                                                    ...
                                                    <tr>
                                                        ...
                                                        @for ($x = 1; $x <= 12; $x++)
                                                            @if (in_array($x, $slc_cronograma_projeto))
                                                                <td>
                                                                    <div class='br-checkbox'>
                                                                        <input disabled
                                                                            id='mobilizacao{{ $x }}'
                                                    ...
                                                    <tr>
                                                        ...
                                                        @for ($x = 1; $x <= 12; $x++)
                                                            @if (in_array($x, $slc_cronograma_liberacao))
                                                                <td>
                                                                    <div class='br-checkbox'>
                                                                        <input disabled
                                                                            id='mobilizacao{{ $x }}'
                                                    ...
                                                    <tr>
                                                        ...
                                                        @for ($x = 1; $x <= 12; $x++)
                                                            @if (in_array($x, $slc_cronograma_visita))
                                                                <td>
                                                                    <div class='br-checkbox'>
                                                                        <input disabled
                                                                            id='mobilizacao{{ $x }}'
                                                    ...
                                                    <tr>
                                                        ...
                                                        @for ($x = 1; $x <= 12; $x++)
                                                            @if (in_array($x, $slc_cronograma_avaliacao))
                                                                <td>
                                                                    <div class='br-checkbox'>
                                                                        <input disabled
                                                                            id='mobilizacao{{ $x }}'
                            ...
                            <div class="wizard-panel-btn">
                                <a href="{{ route('PlanoOperacionalList') }}"><button
                                        class="br-button primary wizard-btn-next" type="button">Sair
                                    </button>
                                </a>
                                <button class="br-button secondary wizard-btn-prev" type="button">Voltar
                                </button>

...
urlpatterns = [
    ...
    path('solicitacaocestas/update/<pk>', SolicitacaoCestasUpdateView.as_view(), name='solicitacaocestas_update'),
    path('solicitacaocestas/solicitacao_cestas_delete_nota/<int:pk>', salvar_avaliador, name='salvar_avaliador'),
]
